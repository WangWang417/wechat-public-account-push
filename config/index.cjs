...
const USER_CONFIG = {
    ...
    // 如果你非要填这里也行。脚本也能运行
    APP_ID: 'wxd97b995be44dab7a',

    // 公众号APP_SECRET
    // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
    // 如果你非要填这里也行。脚本也能运行
    APP_SECRET: '9d7a64e6849e5576f41bb06c4b168a7e',
    ...
    USERS: [
        {
            ...
            id: 'oIkmO50kQH4x-qAFFU7gq5x0ScDM',
            // 你想对他发送的模板消息的模板ID
            useTemplateId: 'wQpHZ94hWGcizyE56jsrD5dZIwurIfIY7Y-qUtzTlfQ',
            // 所在省份
            province: '湖南',
            // 所在城市
            city: '长沙',
            ...
            festivals: [
                ...
                {
                    type: '*生日', name: '小旺', year: '2000', date: '11-14',
                },
                // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
                {
                    type: '生日', name: '宝贝', year: '2000', date: '04-30',
                }
            ],
        ...
        },
        {
            ...
            name: '宝贝01',
            // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
            id: 'oIkmO5_kVlRz-PU0pPfFLyqzzvB0',
            // 你想对他发送的模板消息的模板ID
            useTemplateId: 'wQpHZ94hWGcizyE56jsrD5dZIwurIfIY7Y-qUtzTlfQ',
            // 所在省份
            province: '湖南',
        ...
        },
        {
            ...
            name: '小旺',
            // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
            id: 'oIkmO57Yu4FUrcDbTxTBwf_u7v0k',
            // 你想对他发送的模板消息的模板ID
            useTemplateId: 'wQpHZ94hWGcizyE56jsrD5dZIwurIfIY7Y-qUtzTlfQ',
            // 所在省份
            province: '广东',
